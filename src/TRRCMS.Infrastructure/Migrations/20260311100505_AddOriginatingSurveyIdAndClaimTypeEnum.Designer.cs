...
namespace TRRCMS.Infrastructure.Migrations
{
    ...
    [Migration("20260311100505_AddOriginatingSurveyIdAndClaimTypeEnum")]
    partial class AddOriginatingSurveyIdAndClaimTypeEnum
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.Certificate", b =>
                {
                    ...
                    b.Property<string>("CollectorIdNumber")
                        .HasColumnType("text");

                    b.Property<string>("CollectorRelationship")
                        .HasColumnType("text");
                    ...
                    b.Property<Guid?>("OriginalCertificateId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("RightsSummaryArabic")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("RightsSummaryEnglish")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("OriginalCertificateId");
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.Claim", b =>
                {
                    ...
                    b.Property<Guid?>("OriginatingSurveyId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("OriginatingSurveyId")
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.Community", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GovernorateCode", "DistrictCode", "SubDistrictCode")
                        .HasDatabaseName("IX_Communities_GovernorateCode_DistrictCode_SubDistrictCode");

                    b.HasIndex("GovernorateCode", "DistrictCode", "SubDistrictCode", "Code")
                        .IsUnique()
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.District", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GovernorateCode", "Code")
                        .IsUnique()
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.EvidenceRelation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EvidenceId", "PersonPropertyRelationId", "IsActive")
                        .IsUnique()
                        .HasDatabaseName("IX_EvidenceRelations_EvidenceId_RelationId_IsActive_Unique")
                        .HasFilter("\"IsActive\" = true AND \"IsDeleted\" = false");

                    b.ToTable("EvidenceRelations", (string)null);
                });

            modelBuilder.Entity("TRRCMS.Domain.Entities.Governorate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.Household", b =>
                {
                    ...
                    b.Property<int?>("OccupancyNature")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.Landmark", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.SecurityPolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.Staging.StagingSurvey", b =>
                {
                    ...
                    b.Property<Guid?>("OriginalContactPersonId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ImportPackageId", "OriginalContactPersonId")
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.Street", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.SubDistrict", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GovernorateCode", "DistrictCode")
                        .HasDatabaseName("IX_SubDistricts_GovernorateCode_DistrictCode");

                    b.HasIndex("GovernorateCode", "DistrictCode", "Code")
                        .IsUnique()
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.SyncSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int>("AssignmentsAcknowledged")
                        .HasColumnType("integer");

                    b.Property<int>("AssignmentsDownloaded")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("PackagesFailed")
                        .HasColumnType("integer");

                    b.Property<int>("PackagesUploaded")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("VocabularyVersionsSent")
                        .HasColumnType("jsonb");
                    ...
                    b.HasIndex("FieldCollectorId", "StartedAtUtc");

                    b.ToTable("SyncSessions", (string)null);
                });
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.Certificate", b =>
                {
                    b.HasOne("TRRCMS.Domain.Entities.Person", "BeneficiaryPerson")
                        .WithMany()
                    ...
                    b.HasOne("TRRCMS.Domain.Entities.Certificate", "OriginalCertificate")
                        .WithMany()
                        .HasForeignKey("OriginalCertificateId");
                    ...
                    b.Navigation("OriginalCertificate");
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.Community", b =>
                {
                    b.HasOne("TRRCMS.Domain.Entities.SubDistrict", null)
                        .WithMany("Communities")
                        .HasForeignKey("SubDistrictId");

                    b.HasOne("TRRCMS.Domain.Entities.SubDistrict", "SubDistrict")
                        .WithMany()
                        .HasForeignKey("GovernorateCode", "DistrictCode", "SubDistrictCode")
                        .HasPrincipalKey("GovernorateCode", "DistrictCode", "Code")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.District", b =>
                {
                    b.HasOne("TRRCMS.Domain.Entities.Governorate", "Governorate")
                        .WithMany()
                    ...
                    b.HasOne("TRRCMS.Domain.Entities.Governorate", null)
                        .WithMany("Districts")
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.SecurityPolicy", b =>
                {
                    b.OwnsOne("TRRCMS.Domain.ValueObjects.AccessControlPolicy", "AccessControlPolicy", b1 =>
                        {
                            b1.Property<Guid>("SecurityPolicyId")
                                .HasColumnType("uuid");

                            b1.Property<bool>("AllowPasswordAuthentication")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(true)
                                .HasColumnName("Access_AllowPasswordAuth");

                            b1.Property<bool>("AllowSsoAuthentication")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(false)
                                .HasColumnName("Access_AllowSsoAuth");

                            b1.Property<bool>("AllowTokenAuthentication")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(true)
                                .HasColumnName("Access_AllowTokenAuth");

                            b1.Property<string>("AllowedEnvironments")
                                .HasMaxLength(500)
                                .HasColumnType("character varying(500)")
                                .HasColumnName("Access_AllowedEnvironments")
                                .HasComment("Comma-separated allowed environments");

                            b1.Property<bool>("EnforceIpAllowlist")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(false)
                                .HasColumnName("Access_EnforceIpAllowlist");

                            b1.Property<string>("IpAllowlist")
                                .HasMaxLength(2000)
                                .HasColumnType("character varying(2000)")
                                .HasColumnName("Access_IpAllowlist")
                                .HasComment("Comma-separated allowed IPs/CIDR");

                            b1.Property<string>("IpDenylist")
                                .HasMaxLength(2000)
                                .HasColumnType("character varying(2000)")
                                .HasColumnName("Access_IpDenylist")
                                .HasComment("Comma-separated denied IPs/CIDR");

                            b1.Property<bool>("RestrictByEnvironment")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(false)
                                .HasColumnName("Access_RestrictByEnvironment");

                            b1.HasKey("SecurityPolicyId");

                            b1.ToTable("SecurityPolicies");

                            b1.WithOwner()
                                .HasForeignKey("SecurityPolicyId");
                        });

                    b.OwnsOne("TRRCMS.Domain.ValueObjects.PasswordPolicy", "PasswordPolicy", b1 =>
                        {
                            b1.Property<Guid>("SecurityPolicyId")
                                .HasColumnType("uuid");
                            ...
                            b1.Property<bool>("RequireSpecialCharacter")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(true)
                    ...
                    b.OwnsOne("TRRCMS.Domain.ValueObjects.SessionLockoutPolicy", "SessionLockoutPolicy", b1 =>
                        {
                            b1.Property<Guid>("SecurityPolicyId")
                                .HasColumnType("uuid");
                    ...
                    b.Navigation("AccessControlPolicy")
                        .IsRequired();

                    b.Navigation("PasswordPolicy")
                        .IsRequired();

                    b.Navigation("SessionLockoutPolicy")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.SubDistrict", b =>
                {
                    b.HasOne("TRRCMS.Domain.Entities.District", null)
                        .WithMany("SubDistricts")
                        .HasForeignKey("DistrictId");

                    b.HasOne("TRRCMS.Domain.Entities.District", "District")
                        .WithMany()
                        .HasForeignKey("GovernorateCode", "DistrictCode")
                        .HasPrincipalKey("GovernorateCode", "Code")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.Survey", b =>
                {
                    ...
                    b.HasOne("TRRCMS.Domain.Entities.Person", "ContactPerson")
                        .WithMany()
            ...
            modelBuilder.Entity("TRRCMS.Domain.Entities.Evidence", b =>
                {
                    b.Navigation("EvidenceRelations");
                });
