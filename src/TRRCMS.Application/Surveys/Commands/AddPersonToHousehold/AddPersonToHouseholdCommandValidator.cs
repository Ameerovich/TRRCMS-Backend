...
/// </summary>
public class AddPersonToHouseholdCommandValidator : LocalizedValidator<AddPersonToHouseholdCommand>
{
    public AddPersonToHouseholdCommandValidator(IStringLocalizer<ValidationMessages> localizer, IVocabularyValidationService vocabService) : base(localizer)
    {
